risks_headers = {
    ...
    'risk_mon_head': 'Результуюча величина ризиків',
    'risk_change_head': 'Змінити значення ризику',
}
...
risk_monitor = {
    'set': ['Джерела появи', 'Ризикові події'],
    'code': 'Введіть код ризику : ',
    'code_find': 'Знайти',
    'name': "Ім'я",
    'enabled': 'Наявний',
    'exp': 'Імовірність настання за оцінкою експертів [per]',
    'damage': 'Величина збитку [lrer]',
    'exp_monitor': 'Імовірність настання після застосування заходів [erper]',
    'damage_monitor': 'Величина збитку [elrer]',
    'change': 'Змінити',
}
